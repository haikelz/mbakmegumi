...
const cardData: BentoCardProps[] = [
  {
    img: "/assets/katou-2.jpg",
  },
  {
    img: "/assets/katou-3.jpg",
  },
  {
    img: "/assets/katou-1.jpg",
  },
  {
    img: "/assets/katou-4.jpg",
  },
  {
    img: "/assets/katou-6.jpg",
  },
  {
    img: "/assets/katou-7.jpg",
  },
];
...
function GlobalSpotlight({
  ...
  useEffect(() => {
    ...
    function handleMouseLeave() {
      ...
      gridRef.current?.querySelectorAll(".card").forEach(function (card) {
        (card as HTMLElement).style.setProperty("--glow-intensity", "0");
      });
...
function BentoCardGrid({
  ...
  return (
    <div
      className="bento-section grid w-full gap-3 p-2 max-w-none select-none relative"
      ...
      <BentoCardGrid gridRef={gridRef}>
        <div className="card-responsive grid gap-2">
          {cardData.map(function (card, index) {
            const cardClassName = `card aspect-[4/3] overflow-hidden cursor-pointer flex flex-col justify-between relative min-h-[220px] w-full max-w-full rounded-none border-[4px] border-solid border-[#111] font-black overflow-hidden transition-all duration-150 ease-in-out hover:-translate-x-[3px] hover:-translate-y-[3px] hover:shadow-[8px_8px_0_#111] ${
            ...
            return (
              ...
              >
                {card.img ? (
                  <img
                    src={card.img}
                    alt={card.title || "Megumi gallery image"}
